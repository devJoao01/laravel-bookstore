...
return [
    ...
    'date_format' => 'O :attribute não corresponde ao formato de data :format.',
    ...
    'password' => [
        ...
        'uncompromised' => 'A senha não deve ser uma senha comprometida.',
    ],
    ...
    'unique' => [
        'email' => 'O :attribute já foi registrado.',  // Tradução personalizada do erro de email
    ],
